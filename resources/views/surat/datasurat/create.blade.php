...
<body>
    ...
    <a href="/">Home</a> / <a href="{{route('datasurat.data')}}">Data Klasifikasi Surat</a> / <a href="{{route('datasurat.create')}}">tambah data surat</a>
    
    <form method="post" action="{{ route('datasurat.store') }}">
        <br>
    <div class="mb-3 row">
