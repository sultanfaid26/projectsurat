...
<a href="/">Home</a> / <a href="{{ route('user.guru') }}">Data Guru</a> / <a href="{{ route('user.createGuru') }}">Tambah Data Guru</a>

<br>

<form action="{{ route('user.storeGuru') }}" method="post" class="card p-5 mt-5 bg-dark">
