...
@section('content')
<h1>Data Staff Tu</h1>
<a href="/">Home</a> / <a href="{{ route('user.staff') }}">Data Staff Tu</a>
<br>
    ...
    <a href="{{ route('user.createStaff') }}" class="btn btn-primary mt-5 ">Tambah User</a>
    <form action="{{ route('user.searchStaff') }}" method="get" class="mt-3">
        <div style="width: 500px" class="d-flex">
            ...
            <a href="{{route('user.staff')}}" class="btn btn-danger" style="margin-left: 5px">Reset</a>
        </div>
    </form>
            ...
            @foreach ($user as $item)
                <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      <a href="{{ route('user.editStaff', $item->id) }}" class="btn btn-primary me-3"><i class="ri-edit-line">Edit</i></a>
                        <form action="{{ route('user.deleteStaff', $item->id) }}" method="POST">
                           @csrf
                           @method('DELETE')
